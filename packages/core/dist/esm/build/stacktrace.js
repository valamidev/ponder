...
class ESBuildContextError extends Error {
    constructor() {
        ...
        Object.defineProperty(this, "name", {
            ...
            configurable: true,
            writable: true,
            value: "ESBuildContextError"
        });
    }
}
export function parseViteNodeError(file, error) {
    let resolvedError;
        ...
        for (const { file, lineNumber, column } of userStackFrames) {
            if (file !== null && lineNumber !== null) {
                try {
                    ...
                    codeFrame = codeFrameColumns(sourceFileContents, { start: { line: lineNumber, column: column ?? undefined } }, { highlightCode: true });
                    break;
                }
                catch (err) {
                    // No-op.
    ...
    const verb = resolvedError.name === "ESBuildTransformError"
        ? "transforming"
