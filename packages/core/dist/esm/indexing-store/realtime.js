...
export const createRealtimeIndexingStore = ({ common, schemaBuild: { schema }, }) => {
    let qb = undefined;
            ...
            return {
                values: (values) => {
                    ...
                    const inner = {
                        ...
                        then: (onFulfilled, onRejected) => (async () => {
                            common.metrics.ponder_indexing_store_queries_total.inc({
                                table: getTableName(table),
                                method: "insert",
                            });
