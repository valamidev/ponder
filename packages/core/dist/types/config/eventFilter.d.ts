...
type FilterArgs<abi extends Abi, event extends string> = GetEventArgs<abi, string, {
    EnableUnion: true;
    IndexedOnly: true;
    Required: false;
}, ParseAbiEvent<abi, event>>;
export type GetEventFilter<abi extends Abi, safeEventNames extends string = SafeEventNames<abi>> = {
